...
<body>
    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <h1>Estudiantes de la Universidad Fidélitas</h1>
                <h2>Integrantes:</h2>
                <div id="contenido"></div>
                <div>
                    <p>Nombre: Dennis Zamora Araya <br>
                        Correo electronico: dzamora60763@ufide.ac.cr <br>
                        Contacto: (+506) 8748-9653
                    </p>
                    <p>Nombre: Alejandro Diaz Hidalgo <br>
                        Correo electronico: adiaz60976@ufide.ac.cr <br>
                        Contacto: (+506) 7103-6716
                    </p>
                    <p>Nombre: Andres Barrantes <br>
                        Correo electronico: abarrantes00655@ufide.ac.cr <br>
                        Contacto: (+506) 8529-9853
                    </p>
                    <p>Nombre: Jesus Vargas Marchena <br>
                        Correo electronico: jvargas20795@ufide.ac.cr <br>
                        Contacto: (+506) 8702-1524
                    </p>
    ...
    <script src="funcionalidades/about.js"></script>
</body>
